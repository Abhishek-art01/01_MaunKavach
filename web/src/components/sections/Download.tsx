...
export default function Download() {
  const androidApkUrl =
    "https://github.com/Abhishek-art01/01_MaunKavach/releases/download/v1.0.3/app-release.apk";
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-wrap justify-center gap-6 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col items-center p-10 border border-border bg-card w-full sm:w-72">
            ...
            <p className="text-sm text-muted-foreground font-mono mb-6">v1.0.3</p>
